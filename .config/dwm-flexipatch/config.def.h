...
static const char *fonts[]               = { 
  "IBM Plex Sans:size=12:antialias=true:autohint=true",
...
static const Rule rules[] = {
  ...
  RULE(.class = "firefox",          .tags = 2)
  RULE(.class = "floorp",           .tags = 2)
  RULE(.class = "Navigator",        .tags = 2)
  RULE(.class = "LibreWolf",        .tags = 2)
  RULE(.class = "Brave-browser",    .tags = 2)
  RULE(.class = "Thorium-browser",  .tags = 2)
  RULE(.class = "thorium-browser",  .tags = 2)
  RULE(.class = "qutebrowser",      .tags = 2)
  RULE(.class = "Nyxt",             .tags = 2)
  RULE(.class = "Chromium",         .tags = 2)
  RULE(.class = "Chromium-browser", .tags = 2)
  RULE(.class = "waterfox-current", .tags = 2)

  RULE(.class = "io.github.ungoogled_software.ungoogled_chromium", .tags = 2)
  RULE(.class = "Io.github.ungoogled_software.ungoogled_chromium", .tags = 2)

  RULE(.class = "thunderbird",   .tags = 4)
  RULE(.class = "slack",         .tags = 4)
  RULE(.class = "Steam",         .tags = 4)
  RULE(.class = "Lutris",        .tags = 4)
  RULE(.class = "Timeshift-gtk", .tags = 4, .isfloating = 1)
  RULE(.class = "Evolution",     .tags = 4)
  RULE(.class = "mpv",           .tags = 4)
  RULE(.class = "vlc",           .tags = 4)
  RULE(.class = "parole",        .tags = 4)
  RULE(.class = "smplayer",      .tags = 4)

  // RULE(.class = "Virt-manager",       .tags = 5)
  // RULE(.class = "VirtualBox Manager", .tags = 5, .isfloating = 1)

  // Floating Rules
  RULE(.class = "Arandr",           .isfloating = 1)
  RULE(.class = "Arcologout.py",    .isfloating = 1)
  RULE(.class = "albert",           .isfloating = 1)
  ...
  RULE(.class = "Grub-customizer",  .isfloating = 1)
  RULE(.class = "Pavucontrol",      .isfloating = 1)
  RULE(.class = "pavucontrol",      .isfloating = 1)
  RULE(.class = "Minipad",          .isfloating = 1)
  RULE(.class = "Connman-gtk",      .isfloating = 1)
...
static const char *dmenucmd[] = {
  "rofi", "-show", "run", "-config", "~/.config/rofi/dmenu.rasi", NULL
};
// static const char *dmenucmd[] = {
// 	"dmenu_run",
// 	#if !NODMENU_PATCH
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_apostrophe,  tagtonext_skip,        {0} },
	{ MODKEY|ShiftMask,             XK_semicolon,   tagtoprev_skip,        {0} },
