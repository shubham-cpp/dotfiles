...
local icon_dir = homedir .. "/.local/share/icons/We10X-special-dark/actions/symbolic"
...
theme.titlebar_ontop_button_focus_active        = icon_dir  .. "/window-keep-above-symbolic.svg"
theme.titlebar_ontop_button_normal_active       = icon_dir  .. "/window-keep-below-symbolic.svg"
theme.titlebar_ontop_button_focus_inactive      = icon_dir  .. "/window-keep-above-symbolic.svg"
theme.titlebar_ontop_button_normal_inactive     = icon_dir  .. "/window-keep-below-symbolic.svg"
theme.titlebar_sticky_button_focus_active       = icon_dir  .. "/window-pin-symbolic.svg"
theme.titlebar_sticky_button_normal_active      = icon_dir  .. "/window-pin-symbolic.svg"
