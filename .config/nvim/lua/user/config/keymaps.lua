...
--   vim.cmd "nohl"
--   return "<esc>"
-- end, { desc = "Clear Highlight", silent = true, expr = true })

vim.keymap.set("n", ",w", "<cmd>w!<cr>", { desc = "Save File" })
vim.keymap.set("n", ",W", "<cmd>noautocmd w!<cr>", { desc = "Save File(noautocmds)" })
vim.keymap.set("", "0", "^", { desc = "Goto Beginning", noremap = false, silent = false })
...
vim.keymap.set({ "n", "x" }, "c", '"_c', { nowait = true, silent = true })
